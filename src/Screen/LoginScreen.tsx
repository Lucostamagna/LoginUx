...
const [isLoading, setIsLoading]=useState(false) 
  ...
  return (
    ...
    <View style={{ flex: 1 }}>
      ...
      <LottieView autoPlay={true} style={{ width: width, backgroundColor: "#FFF", alignSelf: "center",}}
      source={require("../../assets/99274-loading.json")}
       />

       <Text
        style={{fontFamily: "", fontSize: 30, color: "black", alignSelf: "center", position: "absolute", top: 225, }}>
        Loading
        </Text>
    ...
    {!isLoading &&
      <>
        ...
        <Text style={{fontSize: 30, color: "#323646", alignSelf: "center", marginTop: 20,}}>
          Welcome to Todify!
        </Text>
        ...
        <TouchableOpacity style={{ backgroundColor: "#50e3c2", borderRadius: 10, justifyContent: "center",alignItems: "center",  height: 50, marginTop: 20, }} onPress={onLogin}>
          <Text style={{ fontSize: 16, color: "#FFF", }}>
            Login
          </Text>
        </TouchableOpacity>
        <Text style={{fontSize: 14,color: "#50e3c2",  padding: 10, textAlign: "center", }}>
          Forgot password?
        </Text>
